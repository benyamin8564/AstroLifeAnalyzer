...
public final class AstrologyEngine {
    ...
    public static List<Double> approximateLongitudes(Date dt) {
        Calendar epoch = Calendar.getInstance();
        epoch.clear();
        epoch.set(2000, Calendar.JANUARY, 1, 12, 0, 0);
        long days = (dt.getTime() - epoch.getTimeInMillis()) / (24L * 60L * 60L * 1000L);
